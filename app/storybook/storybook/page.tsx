    ...
    <div className="min-h-screen bg-bg-base text-text-primary p-8">
      ...
      <section className="mb-12">
        ...
        <div className="flex gap-4">
          <button className="px-4 py-2 bg-primary text-white rounded font-medium hover:opacity-90 transition">Primary Button</button>
          <button className="px-4 py-2 bg-bg-elevated border border-border-subtle text-text-primary rounded font-medium hover:bg-bg-surface transition">Secondary Button</button>
          <button className="px-4 py-2 bg-success text-white rounded font-medium hover:opacity-90 transition">Success Button</button>
        </div>
      </section>
        ...
        <div className="p-6 bg-bg-surface border border-border-subtle rounded-lg">
          ...
          <div className="mt-4 flex justify-between items-center text-sm">
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="w-3 h-3 rounded-full bg-success inline-block ml-2"></span>
