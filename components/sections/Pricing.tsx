...
>
  Monthly
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          {/* Card 1: Starter */}
          <div className="bg-bg-elevated/60 border border-border-subtle hover:border-[color-mix(in_srgb,var(--color-brand)_30%,transparent)] rounded-[24px] p-6 sm:p-8 flex flex-col text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-lg group">
          ...
          <div className="relative scale-100 md:scale-105 z-10 flex flex-col transition-transform duration-300 group/growth">
            ...
            <div className="relative bg-bg-surface border-2 border-brand/30 hover:border-brand/60 rounded-[24px] p-6 sm:p-8 flex flex-col text-left h-full shadow-lg z-10 transition-all duration-300 flex-1 hover:-translate-y-1 hover:shadow-xl">
              <div className="flex flex-col flex-1">
