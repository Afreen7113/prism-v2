        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center pt-8 border-t border-border-subtle">
          ...
          <div className="col-span-1 lg:col-span-7 w-full overflow-hidden">
            <motion.div
              ...
              className="w-full bg-[var(--prism-site-surface,#08090E)] border border-[var(--prism-site-border,rgba(255,255,255,0.05))] rounded-3xl shadow-[0_24px_70px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col sm:flex-row aspect-none sm:aspect-[1.5] min-h-[380px] transition-all duration-300"
            >
              {/* Sidebar Mockup */}
