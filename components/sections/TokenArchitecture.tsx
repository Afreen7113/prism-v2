...
const brands: BrandCard[] = [
  ...
  },
  {
    ...
    brand: 'DevOps Cloud',
    badge: 'DEVELOPER',
    bg: 'bg-[#0B1121] bg-gradient-to-br from-slate-900 to-[#0B1121] border-slate-800 shadow-2xl hover:border-emerald-500/50',
    text: 'text-white',
  ...
  return (
    <section id="white-label-architecture" className="relative py-24 md:py-32 overflow-hidden bg-bg-surface border-y border-border-subtle">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute left-0 right-0 top-0 -mt-24 h-96 bg-brand/5 blur-[120px] rounded-full pointer-events-none" />
      </div>
        ...
        <div className="flex flex-col gap-24">
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-[1000px] w-full mx-auto">
              {brands.map((b, i) => (
                <div key={i} className={`p-6 rounded-[20px] border ${b.bg} flex flex-col justify-between shadow-sm relative overflow-hidden group transition-all duration-250 hover:-translate-y-1 hover:shadow-2xl h-[220px] w-full max-w-[480px] mx-auto`}>
          ...
          <div className="flex flex-col gap-8 items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-[1200px] mx-auto">
              ...
              <div 
                className="rounded-2xl overflow-hidden border border-slate-200 shadow-xl bg-white flex flex-col h-full"
                style={{ 
                  "--color-brand": "#0284c7", 
              ...
              <div 
                className="rounded-2xl overflow-hidden border border-emerald-800 shadow-xl bg-emerald-950 flex flex-col h-full"
                style={{ 
                  "--color-brand": "#10b981", 
          ...
          <div className="max-w-[900px] mx-auto w-full flex flex-col items-center text-center">
            ...
            {showCode && (
              <div className="mt-4 bg-[#0D1117] border border-border-subtle rounded-xl overflow-hidden shadow-xl animate-in fade-in slide-in-from-top-2 duration-300 w-full text-left">
