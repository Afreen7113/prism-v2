      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <motion.div 
            ...
            className="rounded-2xl border border-slate-200/60 bg-white overflow-hidden shadow-xl flex flex-col h-[280px]"
            style={{ 
              '--host-bg': '#ffffff',
              '--host-surface': '#f8fafc',
              '--host-border': '#e2e8f0',
          ...
          <motion.div 
            ...
            className="rounded-2xl border border-slate-800/60 bg-slate-950 overflow-hidden shadow-2xl flex flex-col h-[280px]"
            style={{ 
